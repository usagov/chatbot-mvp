...
(function ($, Drupal, cookies) {
  ...
  Drupal.behaviors.autologout = {
    attach: function (context, settings) {
       ...
       */
      function setUserIsActive(value) {
        // Skip if the dialog is active.
        if (theDialog) {
          return;
        }
        ...
        if (value) {
          ...
          // a half a minute, otherwise sessions never timeouts.
      ...
      function userIsActive() {
        return localStorage.getItem('autologout_page_activity') === 'true';
      }
