...
-------------------------------------
  ...
  * If you use s3fs for public:// files:
    ...
    * You should change your php twig storage folder to a local directory.
      ...
      Change the php_storage settings in your setting.php. It is recommended
      that this directory be outside out of the document root.
...
---------------------------
  ...
  * Because of the way browsers restrict requests made to domains that differ
...
------------
  ...
  * If you are using Nginx as webserver, it is necessary to add additional
