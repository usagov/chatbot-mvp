...
class Settings extends ConfigFormBase {
    ...
    foreach ($breakpoints as $break => $data) {
      ...
      foreach ($cols as $col) {
        ...
        foreach ($existing_layouts as $vals) {
          ...
          $form[$break]['columns'][$col]['layouts'][$option_count]['#weight'] = $vals['weight'] !== NULL ? (int) $vals['weight'] : 0;
          ...
          $form[$break]['columns'][$col]['layouts'][$option_count]['weight'] = [
            ...
            '#default_value' => $vals['weight'] !== NULL ? (int) $vals['weight'] : 0,
   ...
   */
  protected function getTriggerKey(FormStateInterface $form_state): array {
